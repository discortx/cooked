...
export class StateMachine {
    ...
    start() {
        ...
        setTimeout(() => this.phase2(), TIMINGS.stage1_forward);
    }
    ...
    phase2() {
        ...
        setTimeout(() => this.phase3(), TIMINGS.stage2_reverseFull);
    }
    ...
    phase3() {
        ...
        setTimeout(() => this.phase4(), TIMINGS.stage3_forward);
    }
    ...
    phase4() {
        ...
        setTimeout(() => this.phase5(), TIMINGS.stage4_reverseHalf);
    }
    ...
    phase6() {
        ...
        // After bar reaches 85%, turn the line downward
        setTimeout(() => this.phase7(), 200 + TIMINGS.stage6_finalForward);
    }
